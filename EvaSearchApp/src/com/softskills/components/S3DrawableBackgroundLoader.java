...
public class S3DrawableBackgroundLoader {
	...
	private void loadDrawable(SourceContainer sourceContainer, String lookup, final ImageView imageView,Drawable placeholder) {
	...
	private void queueJob(final SourceContainer sourceContainer, final String lookup, 
			final ImageView imageView,final Drawable placeholder) {  
