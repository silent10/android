...
public class SettingsActivity extends AppCompatPreferenceActivity {
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class CredentialsPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("site_code"));
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class ScopePreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
           ...
           // setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
//            bindPreferenceSummaryToValue(findPreference("scope_hotel"));
        }
