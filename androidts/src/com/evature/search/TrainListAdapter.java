...
import com.evature.search.travelport.RailJourney;
import com.evature.search.travelport.RailPricingSolution;
...
public class TrainListAdapter extends BaseAdapter {
	...
	TrainListAdapter(TrainsFragment parent, EvaDatabase evaDatabase) {
		Log.d(TAG, "CTOR");
