...
import com.evature.search.travelport.AirPricingSolution;
import com.evature.search.travelport.AirSegment;
...
public class FlightListAdapterTP extends BaseAdapter {
	...
	FlightListAdapterTP(FlightsFragment parent, EvaDatabase evaDatabase) {
		Log.d(TAG, "CTOR");
