...
// Based on https://github.com/Teaonly/android-eye/blob/master/src/teaonly/droideye/StreamingLoop.java
...
public class StreamingLoop {
	private static String TAG = "StreamingLoop";
	// Local data loopback
	...
	public StreamingLoop() {
        this("evature.search.streamer"+Integer.toHexString( (new Random()).nextInt() ));
	}
