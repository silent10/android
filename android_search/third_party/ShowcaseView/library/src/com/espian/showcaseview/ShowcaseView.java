...
public class ShowcaseView extends RelativeLayout
    ...
    protected TextDrawer mTextDrawer;
    ...
    protected boolean mHasNoTarget = false;
    ...
    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, ConfigOptions options) {
        ...
        mShowcaseDrawer = new ClingDrawerImpl(getResources(), mShowcaseColor, showcaseRadius);
        ...
        mTextDrawer = new TextDrawerImpl(metricScale, mShowcaseDrawer, options.textPadding);
...
//        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        boolean recalculatedCling = mShowcaseDrawer.calculateShowcaseRect(showcaseX, showcaseY, getScaleMultiplier());
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB && !mHasNoTarget) {
        	Path path = mShowcaseDrawer.getPath(showcaseX, showcaseY);
        ...
        if (!mHasNoTarget) {
            mShowcaseDrawer.drawShowcase(canvas, showcaseX, showcaseY, getScaleMultiplier(), showcaseRadius);
        }
...
//        }
    ...
    public float getScaleMultiplier() {
        return mOptions.scaleMultiplier;
    }

    public void setScaleMultiplier(float scaleMultiplier) {
    	this.mOptions.scaleMultiplier = scaleMultiplier;
    }

	public int getShowcaseColor() {
		return mShowcaseColor;
	}

	public void setClingDrawer(ClingDrawer clingDrawerImpl) {
		mShowcaseDrawer = clingDrawerImpl;
		mTextDrawer.setCalculator(clingDrawerImpl);
	}
