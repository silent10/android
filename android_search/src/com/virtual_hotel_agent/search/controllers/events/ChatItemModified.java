...
public class ChatItemModified {
	...
	/***
	 * if startRecord - this chatItem requests a recording to start - and modify the chatItem with the results
	 * 		else - this chatItem text was modified
	 * if chatItem is null - last utterance was deleted
	 */
